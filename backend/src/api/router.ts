...
import { attendanceRouter, attendanceConfigRouter, attendanceRequestsRouter, absenceRouter } from '../modules/attendance/index.js';
...
export const appRouter = {
  ...
  rbac: rbacRouter,
  attendance: { ...attendanceRouter, ...attendanceConfigRouter, ...attendanceRequestsRouter, ...absenceRouter },
